...
export function useOptimizedDocument(documentId: string | null) {
    ...
    useEffect(() => {
        ...
        const setupListener = async () => {
            try {
                ...
                console.error('Failed to setup document listener:', err);
...
export async function createOptimizedDocument(userId: string): Promise<string> {
    try {
        const { db } = await getFirebase();
